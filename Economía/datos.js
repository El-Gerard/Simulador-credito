		...
		function TablaCuotas(){
			...
			if (amort_cf == "Mensual") {
		  		...
		  		for (var i = 0; i < cuotas.length; i++) {
			  		...
			  		capital = capital - amort_cap; // esta variable no va en la tabla
			  		  //A = cuota fija
			  		  //flujo de caja que es = A
	...
	//---------------------------------------Si pestaña 2 esta activada
			...
			if (amort_pg == "Mensual") {
				...
				for (var i = 0; i < gracia_cuotas.length; i++) {
					...
					elementos.push(new Array(cuota, formatNumber.new(capital), "-------", formatNumber.new(F_cuota_gracia), "--------", formatNumber.new(F_cuota_gracia)));
				...
				for (var i = gracia_cuotas.length; i < cuotas1.length; i++) {
					...
					elementos.push(new Array(cuota, formatNumber.new(F_capital), formatNumber.new(F_N_mort_cap), formatNumber.new(F_amort_int), "--------", formatNumber.new(F_caja)));
